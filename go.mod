...
require (
	...
	github.com/go-ap/activitypub v0.0.0-20190124104314-99cabdd26d73
	github.com/go-ap/activitystreams v0.0.0-20190124104215-6a208fd55a29
	github.com/go-ap/jsonld v0.0.0-20190124103729-2f041c2116c4
