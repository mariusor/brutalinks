...
require (
	git.sr.ht/~mariusor/assets v0.0.0-20220809155828-400671d4f174
	...
	github.com/go-ap/fedbox v0.0.0-20220805202038-d9aba91b8fd9
...
require (
	...
	github.com/go-ap/processing v0.0.0-20220731141240-152d866df8c7 // indirect
